  ...
  <SbEditable content={props.blok}>
    ...
    >
      <article className="su-bg-fog-light">
        ...
        {props.blok.headerStyle === "no-image" && <HeaderNoImage {...props} />}
        ...
        {(props.blok.bodyTitle ||
          (props.blok.pageContent != null &&
            Object.keys(props.blok.pageContent).length > 0)) && (
          <section className="ood-interior-page__body">
            {props.blok.bodyTitle && (
              <header className="centered-container ood-interior-page__body-header su-text-align-left">
                <h2 className="ood-interior-page__body-header-title su-serif su-bold ood-has-tab-before">
                  {props.blok.bodyTitle}
                </h2>
              </header>
            )}
            <CenteredContainer flex classes="ood-interior-page__body-container">
