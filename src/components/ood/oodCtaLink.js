...
const OodCtaLink = (props) => (
    ...
    <SbEditable content={props.blok}>
        <li className="nav-item active">
            ...
            <a href={props.blok.url.url} className={props.blok.linkIconClass ? props.blok.linkButtonStyle + " su-link--external" + props.blok.linkIconClass : props.blok.linkButtonStyle + " su-link--external"}>
                { props.blok.linkText }
            </a>}
        </li>
    </SbEditable>
