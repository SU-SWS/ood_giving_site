  ...
  <SbEditable content={props.blok}>
    <div className={`ood-hero-home su-bg-${props.blok.backgroundColor}`}>
      ...
      <div className="centered-container">
        <h1 className={`ood-hero-home__splash-text su-mod-type-${props.blok.splashTextSize} su-text-white su-text-focus-in`}>{props.blok.splashText}</h1>
        <a className={`ood-hero-home__link su-text-white su-bg-${props.blok.ctaBackgroundColor}`} href={props.blok.link} rel="nofollow noopener">
