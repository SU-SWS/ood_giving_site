  ...
  <SbEditable content={props.blok}>
    <div className={`ood-hero-home su-bg-${props.blok.backgroundColor}`}>
      ...
      <div className="centered-container flex-container ood-hero-home__content">
        <h1 className={`flex-lg-8-of-12 ood-hero-home__splash-text su-semibold su-mod-type-${props.blok.splashTextSize} su-text-white su-text-focus-in`}>{props.blok.splashText}</h1>
        <a className={`flex-lg-4-of-12 ood-hero-home__link su-bg-${props.blok.ctaBackgroundColor}`} href={props.blok.link} rel="nofollow noopener">
