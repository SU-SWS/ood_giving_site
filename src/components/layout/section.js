  ...
  <SbEditable content={props.blok}>
    <div id={props.blok.id} className={`section su-bg-${props.blok.backgroundColor} ${props.blok.spacing}`}>
      ...
      <div className={`centered-container section__header`}>
        ...
        {(props.blok.titleHeadingLevel === 'h3' && props.blok.titleHeadingLevel) &&
        <h3
          className={`section__title su-width-${props.blok.titleWidth} su-text-align-${props.blok.titleAlign} su-${props.blok.titleStyle} su-text-${props.blok.titleColor}`}>
          {props.blok.title}
        </h3>
        }
        {(props.blok.titleHeadingLevel === 'h4' && props.blok.titleHeadingLevel) &&
        <h4
          className={`section__title su-width-${props.blok.titleWidth} su-text-align-${props.blok.titleAlign} su-${props.blok.titleStyle} su-text-${props.blok.titleColor}`}>
          {props.blok.title}
        </h4>
        }
        {(props.blok.titleHeadingLevel === 'h5' && props.blok.titleHeadingLevel) &&
        <h5
          className={`section__title su-width-${props.blok.titleWidth} su-text-align-${props.blok.titleAlign} su-${props.blok.titleStyle} su-text-${props.blok.titleColor}`}>
          {props.blok.title}
        </h5>
        }
        {(props.blok.titleHeadingLevel === 'h6' && props.blok.titleHeadingLevel) &&
        <h6
          className={`section__title su-width-${props.blok.titleWidth} su-text-align-${props.blok.titleAlign} su-${props.blok.titleStyle} su-text-${props.blok.titleColor}`}>
          {props.blok.title}
        </h6>
