...
const OodLocalHeader = (props) => (
  <SbEditable content={props.blok}>
    <div className={props.blok.topBarColor ? `ood-header su-bg-white border-top-5px border-color-${props.blok.topBarColor}` : "ood-global-header su-bg-white border-top-5px"}>
