  ...
  if (props.stories) {
    return props.stories.map((story) => {
      ...
      if (typeof story != 'string') {
        ...
        if (window.location.pathname == '/editor/' && !document.cookie.match(/maxRelationsWarning/)) {
          alert('This page has exceeded Storyblok\'s max number of relations per request,' + 
