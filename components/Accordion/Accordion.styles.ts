...
export const listItem = (isDigitalRed: boolean) => cnb('relative mb-0 border-b first:border-t', accordionColors[isDigitalRed ? 'digital-red' : 'palo-alto-light']);
...
export const circleIcon = (isDigitalRed: boolean) => cnb(
  'shrink-0 grow-0 absolute right-10 md:right-20 w-24 h-24 md:w-28 md:h-28 border-2 p-2 md:p-3 rounded-full',
  isDigitalRed ? 'border-digital-red/60 text-digital-red' : 'border-palo-alto-light/60 text-palo-alto-light',
);
