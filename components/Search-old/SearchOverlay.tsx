...
import { FlexCell } from '../Storyblok/partials/FlexCell';
import { CenteredContainer } from '../Storyblok/partials/CenteredContainer';
...
export const SearchOverlay = () => {
  ...
  const searchButton =
    ...
    document.querySelector<HTMLButtonElement>('.ood-header__search-button');
  ...
  const firstTabbableRef = useRef<HTMLButtonElement>(null);
  const lastTabbableRef = useRef<HTMLAnchorElement>(null);
  useFocusTrap({
    firstElemRef: firstTabbableRef,
    lastElemRef: lastTabbableRef,
    isActive: isOpen,
  });
