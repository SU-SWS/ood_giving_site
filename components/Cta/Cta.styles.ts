...
const inlineBase = 'inline underline decoration-1 hocus:decoration-2 underline-offset-2';
...
export const ctaGroup = 'list-unstyled gap-1em [&_li]:mb-0 [&_.cta-button.button-default]:max-sm:text-[.9em] [&_.cta-button]:max-sm:p-07em';
